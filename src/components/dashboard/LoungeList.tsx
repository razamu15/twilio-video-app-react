...
export default function LoungeList(props: any) {
  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-4 xl:px-6 pt-4 pb-4 sm:pb-6 lg:pb-4 xl:pb-6 space-y-4">
      <header className="flex items-center justify-between">
        <h2 className="text-lg leading-6 font-medium text-black">Lounges</h2>
        <button className="hover:bg-blue-200 hover:text-blue-800 group flex items-center rounded-md bg-light-blue-100 text-light-blue-600 text-sm font-medium px-4 py-2">
          <svg
      ...
      <ul className="grid grid-cols-3 gap-4">
        {lounges.map(lounge => {
          return (
            <li className="">
              <a
                href="#"
                className="w-full hover:bg-blue-500 hover:border-transparent hover:shadow-lg group block rounded-lg p-4 border border-gray-400"
              >
                <dl className="grid sm:block lg:grid xl:block grid-cols-2 grid-rows-2 items-center">
                  <div>
                    <dt className="sr-only">Title</dt>
                    <dd className="group-hover:text-white leading-6 text-lg font-medium text-black">{lounge.name}</dd>
                  </div>
                  <div>
                    <dt className="sr-only">Category</dt>
                    <dd className="group-hover:text-blue-200 text-base text-gray-500 font-medium sm:mb-4 lg:mb-0 xl:mb-4">
                      {lounge.game}
                    </dd>
                  </div>
        ...
        <li className="hover:shadow-lg flex rounded-lg">
          <a
            href="/new"
            className="hover:border-transparent hover:shadow-xs w-full flex items-center justify-center rounded-lg border-2 border-dashed border-gray-200 text-sm font-medium p-6"
          >
            New Project
          </a>
        </li>
